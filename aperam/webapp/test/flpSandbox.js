		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aperam App",
									"targetURL": "#comaperamaperam-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comaperamaperam-display": {
								"semanticObject": "comaperamaperam",
								"action": "display",
								"description": "An Aperam application.",
								"title": "Aperam App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.aperam.aperam",
									"url": sap.ui.require.toUrl("com/aperam/aperam")
								}
							}
						}
					}
